...
public class PrintWriterTest {
    ...
    /*public static void main(String[] args) {
        ...
        // 下面3个函数的T作用都是一样：都是将字母“abcde”写入到文件“file.txt”中。
        // 任选一个执行即可！
     ...
     */
    @Test
    public  void testPrintWriterConstrutor1() {
...
//            out.print(arr);
     ...
     */
    @Test
    public  void testPrintWriterConstrutor2() {
        final char[] arr={'a', 'b', 'c', 'd', 'e' };
        try {
            File file = new File("file.txt");
     ...
     */
    @Test
    public  void testPrintWriterConstrutor3() {
        final char[] arr={'a', 'b', 'c', 'd', 'e' };
        try {
